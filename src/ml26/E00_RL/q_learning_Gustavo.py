...
if __name__ == "__main__":
    ...
    n_episodes = 1000
    episode_length = 200
    agent = QLearningAgent(env, alpha=0.1, gamma=.95, epsilon=0.7)
    for e in range(n_episodes):
        ...
        agent.epsilon = agent.epsilon - agent.epsilon / n_episodes # reducir exploración cada que se completa un episodio
